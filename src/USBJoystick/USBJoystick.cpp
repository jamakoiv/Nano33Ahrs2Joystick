...
const uint8_t *arduino::USBJoystick::report_desc(void) {
  ...
  static const uint8_t reportDescriptor[] = {
      ...
      REPORT_ID(1), this->REPORT_ID, USAGE_PAGE(1), 0x09, // Button page.
      ...
      REPORT_COUNT(1), this->BUTTONS_MAX_NUMBER, REPORT_SIZE(1),
      0x01,           // ...of 1 bit of data per report.
...
const uint8_t *arduino::USBJoystick::configuration_desc(uint8_t index) {
  ...
  uint8_t configuration_descriptor_temp[] = {
      ...
      // OUT-endpoint is not necessary for regular joystick that only sends data
      // to host.
      //    ENDPOINT_DESCRIPTOR_LENGTH,         // bLength
      //    ENDPOINT_DESCRIPTOR,                // bDescriptorType
